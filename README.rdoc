...
First of all you will need curl to be present in your system. That's RVM requirement not mine. Then:
  ...
  $ curl https://raw.github.com/bornmw/TwitterBackup/master/twitter_backup > twitter_backup
...
===Windows
Download this file to your disk (open it in browser and Save As twitter_backup.wsf): https://raw.github.com/bornmw/TwitterBackup/master/twitter_backup.wsf

Execute the file. Enter your screen name. A file with tweets backup will appear as TwitterBackup.csv at the folder you saved twitter_backup.wsf to.
